...
- path=`/` = **Home** page
  ![Alt text](./asset/fe/image-1.png)

- path=`/login` = **LoginSignup** page
  ![Alt text](./asset/fe/image-3.png)

- path=`/order` = **OrderHome** page
  ![Alt text](./asset/fe/image-4.png)

  - path=`/order/${types}`
    ![Alt text](./asset/fe/image-5.png)

- path=`/course` = **Course** page
  ![Alt text](./asset/fe/image-6.png)

- path=`/contactus` = **Contact us** page
  ![Alt text](./asset/fe/image-7.png)

- path=`/cart` = **Cart** page
  ![Alt text](./asset/fe/image-8.png)
  ![Alt text](./asset/fe/image-9.png)
  - path=`/paymentReceived}` =**Payment Receiveds** page
    ![Alt text](./asset/fe/image-10.png)
